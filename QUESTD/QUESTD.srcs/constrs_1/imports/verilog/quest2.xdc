...
set_property PACKAGE_PIN U9 [get_ports inx]					
	set_property IOSTANDARD LVCMOS33 [get_ports inx]
...
set_property PACKAGE_PIN T8 [get_ports clkdisp]					
	set_property IOSTANDARD LVCMOS33 [get_ports clkdisp]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports inputdisp]					
	set_property IOSTANDARD LVCMOS33 [get_ports inputdisp]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports outx]					
	set_property IOSTANDARD LVCMOS33 [get_ports outx]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports outy]					
	set_property IOSTANDARD LVCMOS33 [get_ports outy]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
set_property PACKAGE_PIN T5 [get_ports outz]					
	set_property IOSTANDARD LVCMOS33 [get_ports outz]
